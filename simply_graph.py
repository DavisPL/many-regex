...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--py", type=Path, default=Path("py_redos_test_results.json"))
    parser.add_argument("--ts", type=Path, default=Path("ts_redos_test_results.json"))
    parser.add_argument("--cs", type=Path, default=Path("csharp_redos_test_results.json"))
    parser.add_argument("--out", type=Path, default=Path("images/simply_graph.png"))
